...
def getMulti90Data(start):  #获取交易日前90天数据(自动剔除没有数据的日期)，作为该交易日的总数据集(包含已经算好的SENTI)，返回一个DF
...
def outputSENTIMENT_SCORE_DAILYWEIGHTED_Adj(dataframe):
    dataframe.to_csv('/root/work/mfb/alpha/SENTIMENT_SCORE_DAILYWEIGHTED_Adj.csv')

outputSENTIMENT_SCORE_DAILYWEIGHTED_Adj(showMultiData('2018-09-04','2020-12-31'))